...
<section class="product-details">
    ...
    <form class="generic-form" action="deleteProduct" method="POST">
        ...
        <input class="generic-text" id="description" name="description" type="text" placeholder="product description.."
               value="${param.description}" readonly>
        ...
        <input class="generic-text" id="release" name="release" type="date" placeholder="product release date.."
               value="${param.release}" readonly>

        <input class="generic-button" type="submit" id="delete" name="delete" value="DELETE">
